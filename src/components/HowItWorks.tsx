...
export default function HowItWorks() {
  ...
  return (
    <section id="como-funciona" className="scroll-mt-24 bg-ink py-20 text-white sm:py-28">
      <div className="container-page">
        <div className="max-w-2xl">
          <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-accent-300">
            {t.how.eyebrow}
          </span>
          <h2 className="mt-3 text-3xl font-extrabold tracking-tightest sm:text-4xl">{t.how.title}</h2>
