...
const pt = {
  ...
  footer: {
    ...
    callLabel: 'Chamadas e mensagens',
    whatsappLabel: 'WhatsApp (apenas mensagens)',
...
const en: Dict = {
  ...
  footer: {
    ...
    contactHead: 'Contact',
    callLabel: 'Calls & messages',
    whatsappLabel: 'WhatsApp (messages only)',
...
const es: Dict = {
  ...
  footer: {
    ...
    contactHead: 'Contacto',
    callLabel: 'Llamadas y mensajes',
    whatsappLabel: 'WhatsApp (solo mensajes)',
